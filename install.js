const APP_DISPLAY_NAME = "cryptfire";
const APP_NAME = "cryptfire";
const APP_PACKAGE = "/informaction/cryptfire";
const APP_VERSION = "1.0";

const APP_PREFS_FILE="defaults/preferences/foxbeansdef.js";
const APP_XPCOM_SERVICE=null;
const APP_JAR_FILE = "cryptfire.jar";
...
function myPerformInstall(secondTry) {
  ...
  var chromef = instToProfile ? getFolder("Profile", "extensions/cryptfire@cryptfire.com/chrome") : getFolder("chrome");
